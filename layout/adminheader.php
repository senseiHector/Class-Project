...
echo "<nav class=\"green\">
        <div class=\"nav-wrapper\">
          ...
          <ul id=\"slide-out\" class=\"side-nav green left\">
            <li><a class=\"white-text\" href=\"$root/pages/dashboard_admin.php\">Home</a></li>
            <li><a class=\"white-text\" href=\"$root/pages/majors_admin.php\">Majors</a></li>
            <li><a class=\"white-text\" href=\"$root/pages/courses_admin.php\">Courses</a></li>
            <li><a class=\"white-text\" href=\"$root/pages/users.php\">Users</a></li>
